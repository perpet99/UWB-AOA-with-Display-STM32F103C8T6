...
US/%.o US/%.su US/%.cyclo: ../US/%.c US/subdir.mk
...
clean-US:
	-$(RM) ./US/Queue.cyclo ./US/Queue.d ./US/Queue.o ./US/Queue.su ./US/hw_config.cyclo ./US/hw_config.d ./US/hw_config.o ./US/hw_config.su
