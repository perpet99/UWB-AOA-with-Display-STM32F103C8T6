...
{
    _floorplanXScale = 100.00;
    _floorplanYScale = 100.00;
    _floorplanXOffset = 0;
    _floorplanYOffset = 0;
    _floorplanFlipX = false;
    _floorplanFlipY = false;
...
void ViewSettings::setGFCentreX(double x)
{
    emit setGFCentreValueX(x);
}

void ViewSettings::setGFCentreY(double y)
{
    emit setGFCentreValueY(y);
}

void ViewSettings::setGFCentreXY(double x, double y)
{
    emit setGFCentreValueXY(x, y);
}
