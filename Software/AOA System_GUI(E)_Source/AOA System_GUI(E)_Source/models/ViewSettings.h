...
public slots:
    ...
    void setGFCentreX(double x);
    void setGFCentreY(double y);
    void setGFCentreXY(double x, double y);
...
signals:
    ...
    void setGFCentreValueY(double);
    void setGFCentreValueX(double);
    void setGFCentreValueXY(double, double);
