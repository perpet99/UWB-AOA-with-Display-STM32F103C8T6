 ...
 * - Scene interaction (Selecting nodes, mvoing them, ...) - This is handled by QGraphicsScene and GraphicsDataItem.
 * - Unselecting all nodes by clicking on the background.
